...
test.describe('Jupiter Popup Module', () => {
  ...
  test('should close popup when close button is clicked', async ({ page }) => {
    ...
    // Wait for popup to disappear with animation
    await page.waitForTimeout(500)
  ...
  test('should close popup when backdrop is clicked', async ({ page }) => {
    ...
    // Click the backdrop
    await page.locator('[data-popup-backdrop]').click({ position: { x: 10, y: 10 } })
  ...
  test('should allow responsive configuration', async ({ page }) => {
    ...
    await page.evaluate(() => {
      ...
      const popupInstance = window.app._components.find(comp => comp.opts && comp.opts.responsive)
